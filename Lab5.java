...
Lab 5
- Fix logic and make cosw check if there is a character in each letter
...
public static void main(String[] args){
    ...
    while(nameLength < 2){
      ...
      if(answer.length() < 2){
        System.out.println("Please enter in a name that is at least " + "two letters long and no numbers");
        flag = false;
      }
